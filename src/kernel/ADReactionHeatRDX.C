...
ADReactionHeatRDX::validParams()
{
  ...
  params.addRequiredParam<Real>("use_density", "use_density");
  return params;
}

ADReactionHeatRDX::ADReactionHeatRDX(const InputParameters & parameters)
...
ADReal
ADReactionHeatRDX::computeQpResidual()
{
