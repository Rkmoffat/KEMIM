#include "ADComputeLagrangianJCYieldStress.h"

registerMooseObject("kemimApp", ADComputeLagrangianJCYieldStress);

InputParameters
ADComputeLagrangianJCYieldStress::validParams()
{
...
ADComputeLagrangianJCYieldStress::ADComputeLagrangianJCYieldStress(
...
void
ADComputeLagrangianJCYieldStress::initQpStatefulProperties()
{
	//_flow_stress[_qp] = _yield_brit; //this initializes the yield stress value to compute first time step
}

void
ADComputeLagrangianJCYieldStress::computeQpProperties()
{
